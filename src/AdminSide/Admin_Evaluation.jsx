  ...
  if (isEvaluated) {
    return (
      <div>
        ...
        return (
            <div>
                <p>โปรดรอการประเมินจากอาจารย์นิเทศน์</p>
            </div>
          );
    }
  };
                                ...
                                <div className="petition-detail-container">
                                    <div style={{marginTop:'20px'}}>
                                       ...
                                       <div style={{display: 'flex',alignItems: 'center',justifyContent: 'flex-start',marginTop:'10px'}}>
                                            ...
                                            <div style={{display: 'flex',alignItems: 'center',justifyContent: 'flex-start',marginTop:'10px'}}>
                                                <p style={{fontSize:"12px"}}>กรุณารอการยืนยันการตรวจสอบและข้อมูลสหกิจศึกษาจากอาจารย์นิเทศน์</p>
                                            </div>
                                        )}
                                    </div>
                                    <div style={{marginTop:'20px'}}>
...
export default Admin_Evaluation;
