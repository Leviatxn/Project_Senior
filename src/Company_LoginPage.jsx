...
const Company_LoginPage = () => {
  ...
  return (
    <div className="login-page" style={{display:'flex',justifyContent:'center'}}>
      {/* Section ซ้าย */}
      <div className="admin-login-sidebar" style={{width:'80%',}}>
        <div className='role-container'>
            <RoleSwitcher/>
        </div>
        <div className="login-main_container">
            <Logo color = "#A60003" overlayColor = "#fff"/>
            ...
            <h2 className="prof-title">บริษัท</h2>
            ...
            <div>
                ...
                <div className="submit-container" style={{marginTop:'80px '}}>
                    <button type="submit" className="submit-button" style={{background:'#A60003'}}>
...
export default Company_LoginPage;
