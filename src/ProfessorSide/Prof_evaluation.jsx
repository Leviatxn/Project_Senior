...
import { 
  ...
  const FirstEvaluation = ({ evaluationID }) => {
...
const SecondEvaluation = (evaluationID) => {
    const [responses, setResponses] = useState({});
    const [evaluationData, setEvaluationData] = useState([]);
    const [isEvaluated, setIsEvaluated] = useState(false);
                                    ...
                                    <div style={{marginTop:'20px'}}>
                                        ...
                                        <div>
                                        {
                                            evaluationData && evaluationData.evaluation_id ? (
                                                <FirstEvaluation evaluationID={evaluationData.evaluation_id} />
                                            ) : (
                            ...
                            <div className="table-container">
                                ...
                                <div className="petition-detail-container">
                                    ...
                                    <div style={{marginTop:'20px'}}>
                                        ...
                                        {
                                            evaluationData && evaluationData.evaluation_id ? (
                                                <SecondEvaluation evaluationID={evaluationData.evaluation_id} />
                                            ) : (
                                                <div style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
                                                    <p style={{color:'#ddd'}}>รอการยืนยัน</p>
                                                </div>
